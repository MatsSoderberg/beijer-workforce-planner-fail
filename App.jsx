...
function Dashboard({ generatedSchedule, employees, preferences }) {
  return (
    <div className="stack" style={{ marginTop: 20 }}>
      <div className="grid four">
        <KPI title="Medarbetare" value={employees.length} sub="Aktuell personalstyrka" />
        <KPI title="Genererat schema" value={generatedSchedule ? 'Ja' : 'Nej'} sub="Senaste körning" />
        <KPI title="Preferenser" value={Object.keys(preferences || {}).length} sub="Registrerade önskemål" />
        <KPI title="Veckor" value={generatedSchedule?.metadata?.generatedWeeks ?? '-'} sub="I schemaperioden" />
      </div>
    ...
    <div className="preferences-layout">
            ...
            >
              <div>
                ...
                <div className="muted small">
                  {e.department} · {e.employmentPct}% {e.eveningOnly ? '· kväll endast' : ''}
                </div>
              </div>
            </button>
          ))}
      ...
      <section className="card">
        <div className="preferences-header">
          <div>
            <div className="section-title">Personliga önskemål</div>
            <div className="muted">Dessa önskemål används i schemagenereringen och av Copilot.</div>
          </div>
      ...
      <div className="container">
        <header className="hero">
          ...
          <div className="hero-right">
            ...
            <button className="hero-chip" onClick={() => { logout(); setSession(null); }}>
              Logga ut
            </button>
          </div>
        </header>
